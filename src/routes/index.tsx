    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border bg-gradient-to-br from-surface-muted via-background to-surface-muted">
        <div className="mx-auto max-w-7xl px-4 py-10 lg:py-16 grid lg:grid-cols-2 gap-10 items-center">
          <RevealDiv>
            <div>
              <h1 className="text-5xl lg:text-7xl font-display leading-[0.95]">
      ...
      {/* Categorias */}
      <Section id="categorias" title="Categorias" subtitle="Encontre exatamente o que combina com você.">
      ...
      {/* Destaques */}
      <Section id="destaques" title="Produtos em destaque" subtitle="A curadoria da semana pelo time Nova Prime.">
      ...
      {/* Promoções */}
      <Section title="Promoções da semana" subtitle="Preços especiais por tempo limitado.">
        <ProductGrid items={promos} />
      </Section>

      {/* Mais vendidos */}
      <Section id="mais-vendidos" title="Produtos mais vendidos" subtitle="O que a comunidade Nova Prime está levando pra casa.">
        <ProductGrid items={bestSellers} />
      </Section>

      {/* Avaliações */}
      <Section id="avaliacoes" title="Avaliações de clientes" subtitle="Mais de 12.000 avaliações verificadas.">
        <RevealDiv>
      ...
      <RevealDiv>
        <section id="sobre" className="border-y border-border bg-surface-muted/40">
          <div className="mx-auto max-w-7xl px-4 py-16 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <h2 className="font-display text-4xl lg:text-5xl leading-tight">Uma loja pensada para durar.</h2>
      ...
      {/* Pagamentos */}
      <Section id="pagamentos" title="Formas de pagamento" subtitle="Escolha como preferir pagar. Todas as opções com criptografia e antifraude.">
        <RevealDiv>
          <div className="grid md:grid-cols-3 gap-5">
      ...
      {/* FAQ */}
      <Section id="faq" title="Perguntas frequentes" subtitle="Se a sua dúvida não estiver aqui, fale com a gente pelo WhatsApp.">
        <RevealDiv>
      ...
      <RevealDiv>
        <section id="contato" className="border-t border-border">
          <div className="mx-auto max-w-7xl px-4 py-16 grid lg:grid-cols-2 gap-10">
            <div>
              <h2 className="font-display text-4xl lg:text-5xl leading-tight">Vamos conversar.</h2>
